...
public class Ants {
	...
	static int elitist_ants; /*
								 * additional parameter for elitist ant system,
								 * no. elitist ants
								 */

	static int ras_ranks; /*
							 * additional parameter for rank-based version of
							 * ant system
							 */
	 ...
	 */
	{
		...
		// TRACE ( System.out.println(" init trails with
		// %.15f\n",initial_trail); );
	 ...
	 */
	{
		...
		rnd = (int) (Utilities.ran01(Utilities.seed)
				* (double) Tsp.n); /* random number between 0 .. n-1 */
	 ...
	 */
	{
		...
		// TRACE ( System.out.println("mmas specific evaporation on
		// nn_lists\n"); );
	 ...
	 */
	{
		...
		// TRACE ( System.out.println("mmas specific: check pheromone trail
		// limits\n"); );
	 ...
	 */
	{
		...
		// TRACE ( System.out.println("acs specific: global pheromone
		// update\n"); );
	 ...
	 */
	{
		...
		// TRACE ( System.out.println("bwas specific: best-worst pheromone
		// update\n"); );
