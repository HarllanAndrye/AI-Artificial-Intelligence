...
public class AcoTsp {
	 ...
	 */
	{
		return (((InOut.n_tours >= InOut.max_tours) && (Timer.elapsed_time() >= InOut.max_time))
				|| (Ants.best_so_far_ant.tour_length <= InOut.optimal));
	}
	 ...
	 */
	{
		...
		for (k = 0; k < Ants.n_ants; k++) {
			...
			case 1:
				LocalSearch.two_opt_first(
						Ants.ant[k].tour); /* 2-opt local search */
				break;
			case 2:
				LocalSearch.two_h_opt_first(
						Ants.ant[k].tour); /* 2.5-opt local search */
				break;
			case 3:
				LocalSearch.three_opt_first(
						Ants.ant[k].tour); /* 3-opt local search */
				break;
			default:
	 ...
	 */
	{
		...
		iteration_best_ant = Ants
				.find_best(); /* iteration_best_ant is a global variable */

		if (Ants.ant[iteration_best_ant].tour_length < Ants.best_so_far_ant.tour_length) {

			InOut.time_used = Timer
					.elapsed_time(); /* best sol found after time_used */
	 ...
	 */
	{
		...
		if ((InOut.iteration % 100) == 0) {
			...
			System.out.println(
					"try " + InOut.n_try + " iteration " + InOut.iteration + ", b-fac " + InOut.branching_factor);
		}
	}
	 ...
	 */
	{
		...
		// TRACE ( System.out.println("Elitist Ant System Ants.pheromone
		// deposit\n"); );
	 ...
	 */
	{
		...
		// TRACE ( System.out.println("Rank-based Ant System Ants.pheromone
		// deposit\n"); );
	 ...
	 */
	{
		...
		// TRACE ( System.out.println("MAX-MIN Ant System Ants.pheromone
		// deposit\n"); );
	 ...
	 */
	{
		...
		// TRACE ( System.out.println("Best-worst Ant System Ants.pheromone
		// deposit\n"); );
	 ...
	 */
	{
		// TRACE ( System.out.println("Ant colony System global Ants.pheromone
		// deposit\n"); );
